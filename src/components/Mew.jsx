...
Command: npx gltfjsx@6.2.16 public/models/Mew/output/anim.gltf -o src/components/Mew.jsx -r public 
*/
...
export function Model(props) {
  const group = useRef()
  const { nodes, materials, animations } = useGLTF('/models/Mew/output/anim.gltf')
  ...
  return (
    <group ref={group} {...props} dispose={null}>
      <group>
        <group name="Y_UP">
          <group name="Mew" rotation={[-Math.PI, 0, -Math.PI]} scale={[-1, 1, 1]}>
            <group name="Origin">
              <group name="Waist" position={[0, 0.127, -0.016]} rotation={[0.391, 0, Math.PI / 2]}>
          ...
          <skinnedMesh name="Object_1" geometry={nodes.Object_1.geometry} material={materials.Mouth} skeleton={nodes.Object_1.skeleton} />
...
useGLTF.preload('/models/Mew/output/anim.gltf')
